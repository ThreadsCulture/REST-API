...
6. If you did everything correct, https://threadsculture.github.io/REST-API/ will lead to your new docs
...
- Documentation(ReDoc): https://threadsculture.github.io/REST-API/
- SwaggerUI: https://threadsculture.github.io/REST-API/swagger-ui/
- Look full spec:
    + JSON https://threadsculture.github.io/REST-API/swagger.json
    + YAML https://threadsculture.github.io/REST-API/swagger.yaml
- Preview spec version for branch `[branch]`: https://threadsculture.github.io/REST-API/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://threadsculture.github.io/REST-API/ with url from the message: `Server started <url>`
